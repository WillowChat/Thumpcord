 ...
 */
@Mod(modid = "thumpcord", name = "Thumpcord", modLanguage = "kotlin", modLanguageAdapter = "chat.willow.thumpcord.lib.KotlinAdapter", acceptableRemoteVersions = "*", acceptedMinecraftVersions = "[1.11.2]", dependencies = "required-after:thump")
object Thumpcord {
